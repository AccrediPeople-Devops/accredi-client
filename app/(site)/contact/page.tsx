        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl site-text-secondary max-w-4xl mx-auto leading-relaxed mb-12">
              We're here to listen and support. Drop us a line, and we'll get back to you as soon as we can.
            </p>
          </div>
        </div>
      </section>
              ...
              <div className="site-glass backdrop-blur-xl rounded-3xl p-8 shadow-2xl hover:bg-white/15 site-light:hover:bg-white/70 transition-all duration-500 h-full">
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="font-bold site-text-primary mb-1">Office Address</h4>
                      <p className="site-text-secondary">1309 Coffeen Avenue STE 1200</p>
                      <p className="site-text-secondary">Sheridan, Wyoming 82801</p>
                    </div>
                  </div>
                </div>
