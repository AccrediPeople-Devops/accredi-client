    ...
    <div className="min-h-screen site-bg-primary py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="site-glass rounded-2xl p-8 mb-8 backdrop-blur-xl site-border">
          ...
          <h1 className="text-4xl font-bold site-text-primary mb-4">
            Terms & Conditions
          </h1>
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <div className="mb-8">
              <div className="flex items-start mb-4">
                ...
                <h2 className="text-2xl font-semibold site-text-primary">1. Introduction</h2>
              </div>
              <div className="ml-7 site-text-secondary space-y-4">
                <p>Welcome to AccrediPeople Certifications.</p>
                <p>AccrediPeople Certifications ("us", "we", or "our") operates www.accredipeoplecertifications.com (hereinafter referred to as "Service").</p>
                <p>Our Privacy Policy governs your visit to www.accredipeoplecertifications.com, and explains how we collect, safeguard and disclose information that results from your use of our Service.</p>
            ...
            <div className="mb-8">
              <div className="flex items-start mb-4">
                ...
                <h2 className="text-2xl font-semibold site-text-primary">2. Definitions</h2>
              </div>
              <div className="ml-7 site-text-secondary space-y-3">
                <p><strong>SERVICE</strong> means the www.accredipeoplecertifications.com website operated by AccrediPeople Certifications.</p>
                ...
                <p><strong>DATA PROCESSORS (OR SERVICE PROVIDERS)</strong> mean any natural or legal person who processes the data on behalf of the Data Controller. We may use the services of various Service Providers in order to process your data more effectively.</p>
            ...
            <div className="mb-8">
              <div className="flex items-start mb-4">
                ...
                <h2 className="text-2xl font-semibold site-text-primary">3. Information Collection and Use</h2>
              </div>
            ...
            <div className="mb-8">
              <div className="flex items-start mb-4">
                ...
                <h2 className="text-2xl font-semibold site-text-primary">4. Types of Data Collected</h2>
              </div>
              <div className="ml-7 site-text-secondary space-y-6">
                
                <div>
                  <h3 className="text-xl font-semibold site-text-primary mb-3">Personal Data</h3>
                ...
                <div>
                  <h3 className="text-xl font-semibold site-text-primary mb-3">Usage Data</h3>
                ...
                <div>
                  <h3 className="text-xl font-semibold site-text-primary mb-3">Location Data</h3>
                ...
                <div>
                  <h3 className="text-xl font-semibold site-text-primary mb-3">Tracking Cookies Data</h3>
                ...
                <div>
                  <h3 className="text-xl font-semibold site-text-primary mb-3">Other Data</h3>
            ...
            <div className="mb-8">
              <div className="flex items-start mb-4">
                ...
                <h2 className="text-2xl font-semibold site-text-primary">5. Use of Data</h2>
              </div>
              <div className="ml-7 site-text-secondary">
                <p className="mb-3">AccrediPeople Certifications uses the collected data for various purposes:</p>
                <ul className="list-disc list-inside space-y-1 ml-4">
            ...
            <div className="mb-8">
              <div className="flex items-start mb-4">
                ...
                <h2 className="text-2xl font-semibold site-text-primary">6. Retention of Data</h2>
              </div>
              <div className="ml-7 site-text-secondary space-y-4">
            ...
            <div className="mb-8">
              <div className="flex items-start mb-4">
                ...
                <h2 className="text-2xl font-semibold site-text-primary">7. Transfer of Data</h2>
              </div>
              <div className="ml-7 site-text-secondary space-y-4">
                ...
                <p>AccrediPeople Certifications will take all the steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organisation or a country unless there are adequate controls in place including the security of your data and other personal information.</p>
              </div>
            </div>
            ...
            <div className="mb-8">
              <div className="flex items-start mb-4">
                ...
                <h2 className="text-2xl font-semibold site-text-primary">8. Disclosure of Data</h2>
              </div>
              <div className="ml-7 site-text-secondary space-y-4">
                <p>We may disclose personal information that we collect, or you provide:</p>
                
                <div>
                  <h4 className="font-semibold site-text-primary mb-2">Disclosure for Law Enforcement</h4>
                ...
                <div>
                  <h4 className="font-semibold site-text-primary mb-2">Business Transaction</h4>
                  <p>If we or our subsidiaries are involved in a merger, acquisition or asset sale, your Personal Data may be transferred.</p>
                </div>

                <div>
                  <h4 className="font-semibold site-text-primary mb-2">Other cases</h4>
                  <p className="mb-2">We may disclose your information also:</p>
                  <ul className="list-disc list-inside space-y-1 ml-4">
            ...
            <div className="mb-8">
              <div className="flex items-start mb-4">
                ...
                <h2 className="text-2xl font-semibold site-text-primary">9. Security of Data</h2>
              </div>
              <div className="ml-7 site-text-secondary">
            ...
            <div className="mb-8">
              <div className="flex items-start mb-4">
                ...
                <h2 className="text-2xl font-semibold site-text-primary">10. Your Data Protection Rights Under General Data Protection Regulation (GDPR)</h2>
              </div>
              <div className="ml-7 site-text-secondary space-y-4">
                <p>If you are a resident of the European Union (EU) and European Economic Area (EEA), you have certain data protection rights, covered by GDPR.</p>
                <p>We aim to take reasonable steps to allow you to correct, amend, delete, or limit the use of your Personal Data.</p>
                <p>If you wish to be informed what Personal Data, we hold about you and if you want it to be removed from our systems, please email us at Support@accredipeoplecertifications.com</p>
            ...
            <div className="mb-8">
              <div className="flex items-start mb-4">
                <div className="w-3 h-3 bg-lime-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                <h2 className="text-2xl font-semibold site-text-primary">11. Your Data Protection Rights under the California Privacy Protection Act (CalOPPA)</h2>
              </div>
              <div className="ml-7 site-text-secondary space-y-4">
                ...
                <ul className="list-disc list-inside space-y-1 ml-4">
                  ...
                  <li>users are able to change their personal information by emailing us at Support@accredipeoplecertifications.com</li>
                </ul>
                
                <div>
                  <h4 className="font-semibold site-text-primary mb-2">Our Policy on "Do Not Track" Signals:</h4>
            ...
            <div className="mb-8">
              <div className="flex items-start mb-4">
                ...
                <h2 className="text-2xl font-semibold site-text-primary">12. Your Data Protection Rights under the California Consumer Privacy Act (CCPA)</h2>
              </div>
              <div className="ml-7 site-text-secondary space-y-4">
                <p>If you are a California resident, you are entitled to learn what data we collect about you, ask to delete your data and not to sell (share) it. To exercise your data protection rights, you can make certain requests and ask us:</p>
                
                <div>
                  <h4 className="font-semibold site-text-primary mb-2">What personal information we have about you</h4>
                ...
                <div>
                  <h4 className="font-semibold site-text-primary mb-2">To delete your personal information</h4>
                ...
                <div>
                  <h4 className="font-semibold site-text-primary mb-2">To stop selling your personal information</h4>
                ...
                <p>To exercise your California data protection rights described above, please send your request(s) by email: Support@accredipeoplecertifications.com</p>
            ...
            <div className="space-y-8">
              {[
                ...
                },
                {
                  ...
                  title: "CI/CD tools",
                  color: "bg-amber-500",
                  content: "We may use third-party Service Providers to automate the development process of our Service."
                },
                {
                  number: 16,
                  title: "Behavioral Remarketing",
                  color: "bg-sky-500",
                  content: "We may use remarketing services to advertise on third party websites to you after you visited our Service. We and our third-party vendors use cookies to inform, optimise and serve ads based on your past visits to our Service."
                },
                {
                  number: 17,
                  title: "Payments",
                  color: "bg-stone-500",
                  content: "We may provide paid products and/or services within Service. In that case, we use third-party services for payment processing (e.g., payment processors). We will not store or collect your payment card details. That information is provided directly to our third-party payment processors whose use of your personal information is governed by their Privacy Policy. These payment processors adhere to the standards set by PCI-DSS as managed by the PCI Security Standards Council, which is a joint effort of brands like Visa, Mastercard, American Express and Discover. PCI-DSS requirements help ensure the secure handling of payment information."
                },
                {
                  number: 18,
                ...
                },
                {
                  ...
                  title: "Contact Us",
                  color: "bg-blue-600",
                  content: "If you have any questions about this Privacy Policy, please contact us by email: Support@accredipeoplecertifications.com"
                }
              ].map((section) => (
                <div key={section.number} className="mb-8">
                  <div className="flex items-start mb-4">
                    <div className={`w-3 h-3 ${section.color} rounded-full mt-2 mr-4 flex-shrink-0`}></div>
                    <h2 className="text-2xl font-semibold site-text-primary">{section.number}. {section.title}</h2>
                  </div>
                  <div className="ml-7 site-text-secondary">
                    <p>{section.content}</p>
                  </div>
