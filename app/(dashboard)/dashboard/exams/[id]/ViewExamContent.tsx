...
interface ViewExamContentProps {
  id: string;
}

export default function ViewExamContent({ id }: ViewExamContentProps) {
      ...
      try {
        ...
        if (examData.courseId) {
          try {
            ...
            } else if (courseResponse && 'title' in courseResponse) {
              setCourseName((courseResponse as { title: string }).title || "Unknown Course");
            } else {
        ...
        if (examData.questionPaperSetId) {
          try {
            ...
            } else if (questionPaperResponse && 'title' in questionPaperResponse) {
              setQuestionPaperName((questionPaperResponse as { title: string }).title || "Unknown Question Paper");
            } else {
