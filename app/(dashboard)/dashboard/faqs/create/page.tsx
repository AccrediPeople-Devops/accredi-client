    ...
    try {
      ...
      setError(
        err.response?.data?.message ||
          err.message ||
          "Error creating FAQs. Please try again."
      );
    } finally {
      setIsLoading(false);
    }
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-[var(--foreground-muted)]">
              Add frequently asked questions for a course
            </p>
          </div>
          <Link
            href="/dashboard/faqs"
        ...
        <form onSubmit={handleSubmit} className="bg-[var(--card)] rounded-[var(--radius-lg)] border border-[var(--border)] p-6">
          ...
          <div className="mb-6">
            ...
            <select
              ...
              className={`w-full px-4 py-2 border rounded-[var(--radius-md)] bg-[var(--input-bg)] text-[var(--foreground)] focus:outline-none focus:ring-2 focus:ring-[var(--primary)] focus:border-transparent ${
                errors.course ? "border-red-500" : "border-[var(--border)]"
              }`}
            >
